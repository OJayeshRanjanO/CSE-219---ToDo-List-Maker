...
import static saf.settings.AppStartupConstants.SIMPLE_APP_PROPERTIES_FILE_NAME_FINNISH;
import static saf.settings.AppStartupConstants.WORKSPACE_PROPERTIES_FILE_NAME;
import static saf.settings.AppStartupConstants.WORKSPACE_PROPERTIES_FILE_NAME_FINNISH;
...
public abstract class AppTemplate extends Application {
    ...
    public void language() {
        ...
        languageStage.initModality(Modality.APPLICATION_MODAL);
        Button english = new Button("English");
        Button finnish = new Button("Finnish");
        HBox hbox = new HBox(english, finnish);
        ...
        Scene langaugeScene = new Scene(hbox,200,200);
        languageStage.setScene(langaugeScene);
        languageStage.show();
    }
