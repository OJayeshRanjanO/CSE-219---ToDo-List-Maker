...
public class AppFileController {
        ...
        try {
            ...
            if (currentWorkFile != null) {
                ...
                try {
                    ...
                    selectedFile = fc.showSaveDialog(app.getGUI().getWindow());
                } catch (Exception e) {
                    AppMessageDialogSingleton dialog = AppMessageDialogSingleton.getSingleton();
    ...
    private boolean promptToSave() throws IOException {
        ...
        yesNoDialog.show(props.getProperty(SAVE_UNSAVED_WORK_TITLE), props.getProperty(SAVE_UNSAVED_WORK_MESSAGE));//pop up confirm box for save work
        ...
        if (selection.equals(AppYesNoCancelDialogSingleton.YES)) {
            ...
            if (currentWorkFile == null) {
                // PROMPT THE USER FOR A FILE NAME
                try { // Shows dialog box if folder is invalid
                    fc = new FileChooser(); // First step of saving file
                    fc.setInitialDirectory(new File(PATH_WORK));
                    fc.setTitle(props.getProperty(SAVE_WORK_TITLE));
                    fc.getExtensionFilters().addAll(
                            new ExtensionFilter(props.getProperty(WORK_FILE_EXT_DESC), props.getProperty(WORK_FILE_EXT)));
